  ...
  return (
    <form onSubmit={onSubmitHandler} className='max-w-md mx-auto mt-16 border p-8 rounded-lg' >
      ...
      <div className='flex flex-col gap-4' >
        {currentState === 'Login' ? '' : <input type="text" placeholder='Username' className='border p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-950' required /> }
        <input type="email" placeholder='Email' className='border p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-950' required />
        <input type="password" placeholder='Password' className='border p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-950' required />
