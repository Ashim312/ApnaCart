...
const Orders = () => {
  ...
  return (
    <div className='border-t pt-16 text-gray-400' >
          ...
          {orderData.map((item,index) => (
            <div key={index} className='py-4 border-t text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
              ...
              <div className='flex justify-between md:w-1/2' >
                 ...
                 <button onClick= {loadOrderData} className='border px-4 py-2 text-sm font-medium rounded-sm text-violet-900 hover:underline' >Track Order</button>
              </div>
            </div>
          ))}
        </div>
